...
def main():
    ...
    try:
        ...
        # memmap_array = np.load('data/source/nmr_spectra.npy', mmap_mode='r')
        # Access a specific slice or portion of the array
        # This will only load the necessary data into memory
        # spectra = memmap_array[100:200,:]
        ...
        print("data/source/nmr_spectra.npy not found. Creating dummy data for demonstration...")
...
# # Access a specific slice or portion of the array
# # This will only load the necessary data into memory
# part_of_array = memmap_array[100:200,:]
