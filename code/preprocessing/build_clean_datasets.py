...
DATASETS = {
    "train_corpus": dict(
        ...
        water_output="data/combined/combine_unique_MetaboLights_Workbench_WaterFixed_v4.npy",
        edta_output="data/combined/combine_unique_MetaboLights_Workbench_WaterFixed_EDTAMagnitude_v4.npy",
        final_output="data/combined/combine_unique_MetaboLights_Workbench_Water_EDTA_Suppressed_rowMinMax_v4.npy",
        edta_strategy=edta_magnitude_detector,
        edta_kwargs={},
    ),
    "barth": dict(
        input="data/Barth/aligned_128K_Workbench_Barth_Syndrome.npy",
        water_output="data/Barth/aligned_128K_Workbench_Barth_Syndrome_WS625to680Zero_v4.npy",
        edta_output="data/Barth/aligned_128K_Workbench_Barth_Syndrome_WS625to680Zero_EDTASuppressed_v4.npy",
        final_output="data/Barth/aligned_128K_Workbench_Barth_Syndrome_WS625to680Zero_EDTASuppressed_rowMinMax_v4.npy",
        edta_strategy=edta_magnitude_detector,
        edta_kwargs={},
    ),
    "mtbls326": dict(
        input="data/mtbls326/MTBLS326_aligned_spectra.npy",
        water_output="data/mtbls326/MTBLS326_aligned_spectra_WS625to680Zero_v4.npy",
        edta_output="data/mtbls326/MTBLS326_aligned_spectra_WS625to680Zero_EDTASuppressed_v4.npy",
        final_output="data/mtbls326/MTBLS326_aligned_spectra_WS625to680Zero_rowMinMax_v4.npy",
        edta_strategy=edta_magnitude_detector,
        edta_kwargs={},
    ),
    "mtbls563": dict(
        input="data/mtbls563/MTBLS563_aligned_spectra.npy",
        water_output="data/mtbls563/MTBLS563_aligned_spectra_WS625to680Zero_v4.npy",
        edta_output="data/mtbls563/MTBLS563_aligned_spectra_WS625to680Zero_EDTASuppressed_v4.npy",
        final_output="data/mtbls563/MTBLS563_aligned_spectra_WS625to680Zero_rowMinMax_v4.npy",
        edta_strategy=edta_magnitude_detector,
        edta_kwargs={},
    ),
    "brc_t2d_newlabels": dict(
        input="data/BrC_T2D/BC_T2D_newlabels_aligned_spectra.npy",
        water_output="data/BrC_T2D/BC_T2D_newlabels_WS625to680Zero_v4.npy",
        edta_output="data/BrC_T2D/BC_T2D_newlabels_WS625to680Zero_EDTASuppressed_v4.npy",
        final_output="data/BrC_T2D/BC_T2D_newlabels_WS625to680Zero_rowMinMax_v4.npy",
        edta_strategy=edta_magnitude_detector,
        edta_kwargs={},
    ),
}
